...
const navLinks = [
   ...
   { title: "Productos", path: "/about", offset: -55 },
   { title: "Soporte", path: "/contact", offset: -130 },
];
   ...
   return (
      <nav
         className={`fixed top-0 left-0 right-0 z-50 lg:mb-4 pb-4 shadow-sticky ${
            scrolling
               ? "bg-[#424865] bg-opacity-40  backdrop-blur-sm"
               : "md:bg-transparent bg-[#00040F] bg-opacity-100"
         }`}
      >
         <div className="flex items-center justify-between p-4 pb-0 font-medium">
            <a href={"/"} className=" text-2xl md:text-3xl text-white font-semibold">
               <p className="flex items-center text-2xl md:text-3xl 2xl:text-4xl">
                  <span
